...
object IMPluginResAssets extends Controller {
   ...
   */
  def at(fileuid: String, setting: String = "default", source: String = "default"): Action[AnyContent] = Action { request =>
    ...
    api.IMPlugin.getRes(fileuid, source, setting).map { resizedImage =>
